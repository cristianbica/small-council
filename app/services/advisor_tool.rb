# Base class for all Advisor tools
# Advisor tools have limited access - primarily read-only with specific write capabilities
class AdvisorTool
  ...
  # Advisor tools are read-only by default
  # Override in subclasses that need write access
  def read_only?
    true
  end
